...
// Google Auth
if (process.env.NEXT_PUBLIC_AUTH_GOOGLE_ENABLED === 'true' && process.env.AUTH_GOOGLE_ID && process.env.AUTH_GOOGLE_SECRET) {
  providers.push(
    GoogleProvider({
...
// Github Auth
if (process.env.NEXT_PUBLIC_AUTH_GITHUB_ENABLED === 'true' && process.env.AUTH_GITHUB_ID && process.env.AUTH_GITHUB_SECRET) {
  providers.push(
    GitHubProvider({
